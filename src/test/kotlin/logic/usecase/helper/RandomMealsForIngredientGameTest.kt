...
class RandomMealsForIngredientGameTest {

    private lateinit var randomMealsForIngredientGame: RandomMealsForIngredientGame
    ...
    @Test
    fun `getMeals should return 15 random meals when repo mapper return 15 meals or more`() {
        //Given
        every { mapper.map(LIST_OF_VALID_NORMAL_MEALS) } returns LIST_OF_VALID_15_MEALS
        randomMealsForIngredientGame = RandomMealsForIngredientGame(repository, mapper)
        //When
        val result = randomMealsForIngredientGame.getMeals(15)
        //Then
    ...
    @Test
    fun `getMeals should throw MealsNotEnoughException when mapped meals less than we want`() {
        //Given
        ...
        assertThrows<MealsNotEnoughException> {
            randomMealsForIngredientGame.getMeals(15)
        }
    }
