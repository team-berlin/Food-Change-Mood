...
class SearchAlgorithm: SearchByName {
    override fun search(textToSearchIn: String, wordToSearchBy: String): Boolean {
        return kmpSearchAlgorithm(textToSearchIn,wordToSearchBy)||levenshteinDistanceSearchAlgorithm(textToSearchIn,wordToSearchBy)
    }
