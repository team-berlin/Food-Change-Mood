...
class IngredientGameMealsMapperTest {
    ...
    @Test
    fun `map should throw exception when list of meals is empty`() {
        //Given
    ...
    @Test
    fun `map should throw exception when list of meals has meal not have ingredients`() {
        //Given
    ...
    @Test
    fun `map should return list of meals after mapped to list for ingredient game exactly same size `() {
        //Given
    ...
    @Test
    fun `map should throw exception when try to find wrong ingredients 500 attempts`() {
    ...
    @Test
    fun `map should throw exception when try to find wrong ingredients 500 attempts only one meal`() {
