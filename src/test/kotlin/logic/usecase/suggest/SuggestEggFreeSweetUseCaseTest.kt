...
class SuggestEggFreeSweetUseCaseTest {
    ...
    private val sweetWithEgg = createMeal(
        name = "Custard Tart", id = 3, minutes = 45, tags = listOf("sweet", "tart"),
    ...
    private val savoryMeal = createMeal(
        name = "Pasta Carbonara", id = 4, minutes = 30, tags = listOf("savory", "pasta"),
        ingredients = listOf("pasta", "egg", "bacon", "cheese"),
        steps = listOf("Cook pasta", "Prepare sauce", "Combine")
    )

    private val meringue = createMeal(
        name = "Meringue", id = 5, minutes = 50, tags = listOf("Sweet"), // Different casing for "sweet"
        ingredients = listOf("egg white", "sugar", "vanilla"), steps = listOf("Beat egg whites", "Add sugar", "Bake")
    )
